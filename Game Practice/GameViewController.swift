...
//  Copyright © 2020 Servika. All rights reserved.
//
...
class GameViewController: UIViewController {
    ...
    // The ship
    var ship: SCNNode! // Восклицательный знак - обещаем, что инициализируем
    ...
    func spanShip() {
        ...
        ship.runAction(.move(to: SCNVector3(), duration: duration)) {
            ...
            // Следующую команду лучше использовать только из главного потока
